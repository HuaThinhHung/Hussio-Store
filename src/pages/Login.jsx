        ...
        <div className="rounded-2xl bg-white px-8 py-10 shadow-xl shadow-neutral-200/50">
          <div className="mb-8 text-center">
            ...
            <p className="mt-2 text-sm text-neutral-500">
              Chào mừng bạn quay trở lại HUSSIO
            </p>
          </div>
          ...
          <div className="space-y-3">
            <button className="flex w-full items-center justify-center gap-3 rounded-lg border border-neutral-200 py-3 text-sm font-medium text-neutral-700 transition hover:bg-neutral-50">
